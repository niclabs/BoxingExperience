...
#define PACKAGE_STRING "vlc 2.1.0-git"
...
#define PACKAGE_VERSION "2.1.0-git"
...
#define VERSION "2.1.0-git"

/* Simple version string */
#define VERSION_MESSAGE "2.1.0-git Rincewind"

/* compiler */
#define VLC_COMPILER "gcc version 4.6.3 (Ubuntu/Linaro 4.6.3-1ubuntu5)"

/* user who ran configure */
#define VLC_COMPILE_BY "jcarrera"

/* host which ran configure */
#define VLC_COMPILE_HOST "jcarrera-OptiPlex"

/* Define to limit the scope of <windows.h>. */
#define WIN32_LEAN_AND_MEAN /**/

/* Define if you want to build for Windows Store apps */
