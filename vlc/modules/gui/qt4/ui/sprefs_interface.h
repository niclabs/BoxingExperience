...
public:
    ...
    void setupUi(QWidget *SPrefsInterface)
    {
        ...
        SPrefsInterface->resize(734, 687);
        ...
        gridLayout_3->addWidget(OneInterfaceBox, 1, 0, 1, 2);
        ...
        gridLayout_3->addWidget(playlistGroupBox, 3, 0, 1, 2);
        ...
        gridLayout1->addWidget(notificationComboLabel, 5, 0, 1, 2);
        ...
        gridLayout_3->addWidget(LooknfeelBox, 0, 0, 1, 2);
        ...
        QWidget::setTabOrder(systrayBox, stylesCombo);
