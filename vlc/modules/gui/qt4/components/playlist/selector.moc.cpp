...
static const char qt_meta_stringdata_PLSelector[] = {
    ...
    "item\0setSource(QTreeWidgetItem*)\0"
...
void PLSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setSource((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1]))); break;
        case 2: _t->plItemAdded((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->plItemRemoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->inputItemUpdate((*reinterpret_cast< input_item_t*(*)>(_a[1]))); break;
        case 5: _t->podcastAdd((*reinterpret_cast< PLSelItem*(*)>(_a[1]))); break;
        case 6: _t->podcastRemove((*reinterpret_cast< PLSelItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
