...
LIBAV_CONFIGURATION=--extra-ldflags=' -L/home/jcarrera/Documents/vlc/contrib/i686-linux-gnu/lib' --cc=gcc --disable-doc --disable-decoder=bink --disable-encoder=vorbis --enable-libgsm --enable-libopenjpeg --disable-debug --disable-avdevice --disable-devices --disable-avfilter --disable-filters --disable-bsfs --disable-bzlib --enable-libmp3lame --enable-libvpx --disable-decoder=libvpx --disable-decoder=libvpx_vp8 --disable-decoder=libvpx_vp9 --arch=x86 --target-os=linux --enable-pic --enable-pthreads --prefix=/home/jcarrera/Documents/vlc/contrib/i686-linux-gnu --enable-static --disable-shared
prefix=/home/jcarrera/Documents/vlc/contrib/i686-linux-gnu
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -L/home/jcarrera/Documents/vlc/contrib/i686-linux-gnu/lib -L/home/jcarrera/Documents/vlc/contrib/i686-linux-gnu/lib  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-ldl -lvpx -lopenjpeg -lmp3lame -lgsm -lm -pthread -lz 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
